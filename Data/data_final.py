...
Original file is located at
    https://colab.research.google.com/drive/1eLNer--_A5BVKv9_WOCNO0yeGlKfNl2I
"""
...
target_column = 'Possibility'  # Target column
...
X = data[categorical_features + numeric_features].values
...
X_train[:, len(categorical_features):] = scaler.fit_transform(X_train[:, len(categorical_features):])
X_test[:, len(categorical_features):] = scaler.transform(X_test[:, len(categorical_features):])

# Use mean imputation (or 'median' or 'most_frequent' as needed)
...
# Print the results
print(f"Custom Naive Bayes Model Accuracy: {accuracy:.2f}")
print(f"Custom Naive Bayes Model F1 Score: {f1:.2f}")
...
ensemble_model = EnsembleClassifier(models=[naive_bayes, svm, decision_tree, knn])
...
accuracy_naive_bayes_custom = 0.79
f1_naive_bayes_custom = 0.76
accuracy_naive_bayes_inbuilt = 0.81
f1_naive_bayes_inbuilt = 0.87
accuracy_svm = 0.83
f1_svm = 0.89
accuracy_dt = 0.78
f1_dt = 0.85
accuracy_knn = 0.78
f1_knn = 0.85
accuracy_ensemble = 0.81
f1_ensemble = 0.77

# Model names
models = ['Custom Naive Bayes', 'GaussianNB', 'SVM', 'Decision Tree', 'KNN', 'Ensemble Model']

# Accuracy and F1-scores for each model
accuracy_scores = [accuracy_naive_bayes_custom, accuracy_naive_bayes_inbuilt, accuracy_svm, accuracy_dt, accuracy_knn, accuracy_ensemble]
f1_scores = [f1_naive_bayes_custom, f1_naive_bayes_inbuilt, f1_svm, f1_dt, f1_knn, f1_ensemble]

# Print accuracies and F1 scores
print("Model Performance:")
for model, acc, f1 in zip(models, accuracy_scores, f1_scores):
    print(f"{model}:")
...
# Plotting the F1-scores next to the accuracy bars
